...
Retain `third_party/MILLENNIUM-LICENSE.md` and the provenance in
`third_party/README.md` with the copied Millennium material. Native Go
executables also incorporate separately licensed module dependencies.
